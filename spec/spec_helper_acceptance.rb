...
RSpec.configure do |c|
  ...
  c.before :suite do
    ...
    # Just for testing
    #
    install_module_from_forge('saz-limits', '2.5.0')
    install_module_from_forge('herculesteam-augeasproviders_sysctl', '2.2.0')
    install_module_from_forge('enterprisemodules-easy_type')
    install_module_from_forge('enterprisemodules-ora_install')
    install_module_from_forge('enterprisemodules-ora_config')
    install_module_from_forge('puppetlabs-stdlib')
    install_module_from_forge('ipcrm-echo')
    install_module_from_forge('puppet-archive')
    install_module_from_forge('herculesteam-augeasproviders_core')
    install_module_from_forge('herculesteam-augeasproviders_sysctl')
    install_module_from_forge('saz-limits')
    install_module_from_forge('puppetlabs-firewall')
    install_module_from_forge('crayfishx-firewalld')
  end
end
