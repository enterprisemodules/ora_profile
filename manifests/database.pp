...
# ## before classes
#
# Sometimes this is not enough and you would like to add some extra definitions. You can. For example, adding a Puppet class to be executed after the `systctl` stage is done and before the `limits` is done. You can do this by adding the following line to your yaml data:
#
# ```yaml
...
# ## Skipping
#
# Sometimes, organizations use different modules and mechanisms to implement a feature and you may want to skip a class:
#
# ```yaml
