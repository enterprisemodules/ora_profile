...
#
# @param [Optional[String[1]]] db_version
...
#    When you don't specify the `doc_version`, puppet automatically uses the latest version for your current `db_version`.
#
# @param [Array[String[1]]] skip_list
#    This is the list of controls that you want to skip.
#    By default this value is empty, meaning `ora_cis` will apply **ALL** controls. You must specify the name of the control.
#
#--++--
class ora_profile::database::cis_controls(
  String[1]           $dbname,
  Optional[String[1]] $db_version,
